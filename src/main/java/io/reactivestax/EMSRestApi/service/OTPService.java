...
//
//        Otp otp = new Otp();
//        otp.setId(otpDTO.getOtpId());
//        otp.setValidOtp(otpDTO.getValidOtp());
//        otp.setCreatedAt(otpDTO.getCreatedAt());
//        otp.setLastAccessed(otpDTO.getLastAccessed());
//        otp.setValidationRetryCount(otpDTO.getValidationRetryCount());
//        otp.setIsValid(otpDTO.getIsValid());
